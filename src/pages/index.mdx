...
<QA>
  ...
  <div slot="answer">
    ...
    You need to fill the required information and submit the form. Make sure the `Work Email` is your real email that can receive the verification code. Other fields can be filled with any information. Once the org is created, you can follow the instructions you received by email to access the org.
